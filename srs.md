...
|2020/05/31|3.0|・目次の記述修正<br>・1-3節　プロジェクトの記述修正、ユーザの定義削除、期日の記述追加<br>・1-4節　ユーザの定義追加<br>・2節　権限別による利用可能機能の表を修正、権限別による利用可能権限の図を追加<br>・2-1-1節　東京学芸大学生涯メールシステムのドメインを持つという記述の削除<br>・2-1-7節　実行中のプロジェクト及びタスクの遅れ発生表示を2-2-4節から移動|
