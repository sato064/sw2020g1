...
|2020/06/22|7.0|2-2-1.終了したプロジェクト内ではタスクの作成ができない旨追加<br>2-3-1.終了したプロジェクトに関して情報変更ができない旨追加<br>2-4-1.終了したタスクに関して情報変更ができない旨追加<br>|
...
#### 2-3-1.プロジェクトの情報変更
プロジェクトホストは、状態が予定及び実行中であるプロジェクトの情報（タイトル、概要、プロジェクトホスト、参加者、状態、期日）を変更することが出来る。プロジェクトホストの変更は、プロジェクトホストがプロジェクトの参加者から指定することで即座に権限保持者を変更できる。プロジェクトホストを変更した場合、もとのプロジェクトホストは参加者となる。
