...
VALUES (`a181408w`, `近藤羽音`, `hanehane`), (`e185401f`, `市川晴也`, `seiyaseiya`), (`e185408w`, `佐藤央`, `oooooooo`), (`e185417m`, `渡邊幹斗`, `kantokanto`);

UNLOCK　TABLES;

-- LOCK TABLES `projects` WRITE;
-- INSERT INTO `projects` (`title`, `overview`,　`host_id`, `deadline`,　`status`, `is_delayed`) VALUES (`親睦会`, `これからともにアプリ開発していくので懇親会をしましょう！`, `a181408w`, '2020-04-01 00:00:00', `2`, `true`), (`2020年G1春課題`, `研究室で使う共有ToDoリストのアプリ開発`, `e185401f`, '2020-10-16 00:00:00', `1`, `false`)；
-- UNLOCK　TABLES;
...
-- INSERT INTO `participates` VALUES (`a181408w`, `1`, `true`), (`a181408w`, `2`, `false`), (`e185401f`, `1`, `false`), (`e185401f`, `2`, `true`), (`e185408w`, `1`, `false`), (`e185408w`, `2`, `false`), (`e185417m`, `1`, `false`), (`e185417m`, `2`, `false`)；
-- UNLOCK　TABLES;

-- LOCK TABLES `handles` WRITE;
-- INSERT INTO `handles` VALUES (`1`, `2`, `e185417m`), (`2`, `2`, `a181408w`), (`3`, `2`, `e185408w`), (`4`, `2`, `e185401f`)；
-- UNLOCK　TABLES;
